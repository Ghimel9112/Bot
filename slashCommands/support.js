...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.io/atacdeelicoptere")
      ...
      interaction.reply({ephemeral: true, 
        embeds: [new MessageEmbed()
          ...
          .setFooter(client.user.username, 'https://imgur.com/jPItIw0.gif')
