  ...
  options: [ 
    ...
    try {    
      if(user) {
        ...
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.io/atacdeelicoptere")
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${user.username} | powered by Ghimel`, "https://imgur.com/jPItIw0.gif")],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by Ghimel`, "https://imgur.com/jPItIw0.gif")],
          components: allbuttons
        });
      }
    } catch (e) {
