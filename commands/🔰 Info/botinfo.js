...
module.exports = {
    ...
    try{
      let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed().setColor('DARK_RED')
      .setAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.io/atac_de_elicoptere")]})
